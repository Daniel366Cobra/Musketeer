...
public class ModSounds {
    ...
    public static final Identifier MUSKET_BUTTSTROKE_ID = new Identifier(MOD_ID,"musket_buttstroke");
    public static SoundEvent MUSKET_BUTTSTROKE = new SoundEvent(MUSKET_BUTTSTROKE_ID);
    ...
    public static void register() {
        ...
        Registry.register(Registry.SOUND_EVENT, ModSounds.MUSKET_BUTTSTROKE_ID, ModSounds.MUSKET_BUTTSTROKE);
