...
public abstract class BaseProjectileEntity extends Entity {
    ...
    private boolean shouldLeaveOwner() {
        ...
        if (ownerEntity != null) {
            for (Entity iterEntity : this.world.getOtherEntities(this, this.getBoundingBox().stretch(this.getVelocity()).expand(1.0), entity -> !entity.isSpectator() && entity.canHit())) {
